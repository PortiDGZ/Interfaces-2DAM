...
namespace EjercicioDatGrid {
    ...
    public partial class alumnosDataSet : global::System.Data.DataSet {
        ...
        public partial class alumnoDataTable : global::System.Data.TypedTableBase<alumnoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public alumnoRow AddalumnoRow(string DNI, string Nombre, string Apellido, string Curso, string Telefono, string Provincia, string Poblacion) {
        ...
        public partial class alumnoRow : global::System.Data.DataRow {
            ...
            public string Provincia {
                get {
                    try {
                        return ((string)(this[this.tablealumno.ProvinciaColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Provincia\' de la tabla \'alumno\' es DBNull.", e);
                    }
                }
                set {
                    this[this.tablealumno.ProvinciaColumn] = value;
                }
            }
            ...
            public string Poblacion {
                get {
                    try {
                        return ((string)(this[this.tablealumno.PoblacionColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Poblacion\' de la tabla \'alumno\' es DBNull.", e);
                    }
                }
                set {
                    this[this.tablealumno.PoblacionColumn] = value;
                }
            }
            ...
            public bool IsProvinciaNull() {
                return this.IsNull(this.tablealumno.ProvinciaColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetProvinciaNull() {
                this[this.tablealumno.ProvinciaColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bool IsPoblacionNull() {
                return this.IsNull(this.tablealumno.PoblacionColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetPoblacionNull() {
                this[this.tablealumno.PoblacionColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace EjercicioDatGrid.alumnosDataSetTableAdapters {
    ...
    public partial class alumnoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `alumno` WHERE ((`DNI` = @p1) AND ((@p2 = 1 AND `Nombre` IS NULL) OR (`Nombre` = @p3)) AND ((@p4 = 1 AND `Apellido` IS NULL) OR (`Apellido` = @p5)) AND ((@p6 = 1 AND `Curso` IS NULL) OR (`Curso` = @p7)) AND ((@p8 = 1 AND `Telefono` IS NULL) OR (`Telefono` = @p9)) AND ((@p10 = 1 AND `Provincia` IS NULL) OR (`Provincia` = @p11)) AND ((@p12 = 1 AND `Poblacion` IS NULL) OR (`Poblacion` = @p13)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `alumno` (`DNI`, `Nombre`, `Apellido`, `Curso`, `Telefono`, `Provinci" +
                "a`, `Poblacion`) VALUES (@p1, @p2, @p3, @p4, @p5, @p6, @p7)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `alumno` SET `DNI` = @p1, `Nombre` = @p2, `Apellido` = @p3, `Curso` = @p4, `Telefono` = @p5, `Provincia` = @p6, `Poblacion` = @p7 WHERE ((`DNI` = @p8) AND ((@p9 = 1 AND `Nombre` IS NULL) OR (`Nombre` = @p10)) AND ((@p11 = 1 AND `Apellido` IS NULL) OR (`Apellido` = @p12)) AND ((@p13 = 1 AND `Curso` IS NULL) OR (`Curso` = @p14)) AND ((@p15 = 1 AND `Telefono` IS NULL) OR (`Telefono` = @p16)) AND ((@p17 = 1 AND `Provincia` IS NULL) OR (`Provincia` = @p18)) AND ((@p19 = 1 AND `Poblacion` IS NULL) OR (`Poblacion` = @p20)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `DNI`, `Nombre`, `Apellido`, `Curso`, `Telefono`, `Provincia`, `Poblacion`" +
                " FROM `alumno`";
