...
namespace insertalumno {
    ...
    public partial class interfacesDataSet1 : global::System.Data.DataSet {
        ...
        public partial class alumnosDataTable : global::System.Data.TypedTableBase<alumnosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public alumnosRow AddalumnosRow(int id_alumno, string alumno) {
...
namespace insertalumno.interfacesDataSet1TableAdapters {
    ...
    public partial class alumnosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `alumnos` WHERE ((`id_alumno` = @p1) AND (`alumno` = @p2))";
            ...
            param.IsNullable = true;
            param.SourceColumn = "alumno";
            param.SourceVersion = global::System.Data.DataRowVersion.Original;
            this._adapter.DeleteCommand.Parameters.Add(param);
            this._adapter.InsertCommand = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO `alumnos` (`id_alumno`, `alumno`) VALUES (@p1, @p2)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `alumnos` SET `id_alumno` = @p1, `alumno` = @p2 WHERE ((`id_alumno` = @p3)" +
                " AND (`alumno` = @p4))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `id_alumno`, `alumno` FROM `alumnos`";
